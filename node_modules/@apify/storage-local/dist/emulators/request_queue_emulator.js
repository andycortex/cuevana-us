...
const unprocessed_request_1 = require("./batch_add_requests/unprocessed_request");
...
class RequestQueueEmulator {
    constructor({ queueDir, dbConnections }) {
        ...
        Object.defineProperty(this, "_selectById", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_deleteById", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_selectByName", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_selectModifiedAtById", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_insertByName", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_updateNameById", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_updateModifiedAtById", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_updateAccessedAtById", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_adjustTotalAndHandledRequestCounts", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_selectRequestOrderNoByModel", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_selectRequestJsonByModel", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_selectRequestJsonsByQueueIdWithLimit", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_insertRequestByModel", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_updateRequestByModel", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_deleteRequestById", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_selectOrInsertTransaction", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_addRequestTransaction", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_addRequestsTransaction", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_updateRequestTransaction", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "_deleteRequestTransaction", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    batchAddRequests(requestModels) {
        if (!this._addRequestsTransaction) {
            this._addRequestsTransaction = this.db.transaction((models) => {
                const result = {
                    processedRequests: [],
                    unprocessedRequests: [],
                };
                for (const model of models) {
                    try {
                        ...
                        if (err.code === ERROR_REQUEST_NOT_UNIQUE) {
                            // If we got here it means that the request was already present.
                            result.unprocessedRequests.push(new unprocessed_request_1.UnprocessedRequest(model.id, model.url, model.method));
                        }
