...
export declare class ScheduleClient extends ResourceClient {
     ...
     */
    update(newFields: ScheduleUpdateData): Promise<Schedule>;
    /**
...
export declare type ScheduleUpdateData = Partial<Pick<Schedule, 'name' | 'cronExpression' | 'timezone' | 'isEnabled' | 'isExclusive' | 'description' | 'actions'>>;
